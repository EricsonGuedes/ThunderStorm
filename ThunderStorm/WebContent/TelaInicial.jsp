					...
					<div class="form-group col-md-7">
						...
						<div class="row">
							<strong>&nbsp;&nbsp;&nbsp;</strong> <input class="form-control"
								...
								style="width: 350px" />
								<strong>&nbsp;&nbsp;</strong>
								<a onclick="CalculaDistancia()" class="btn btn-outline-info"><svg class="bi bi-map" width="1.2em" height="1.2em" viewBox="0 0 19 19" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
